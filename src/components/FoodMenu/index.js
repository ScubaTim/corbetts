      ...
      <Container id="foodMenu" className="containerStyle">
        ...
        <Row xs="1" sm="2" md="4">
          ...
          <Col>
            <h5>Wing Sauces:</h5>
            <p>
              Mild, Medium, Hot, Killer, Garlic, <br />
              BBQ, Tangy BBQ, or House. <br />
              Extra sauce .50
            </p>
          </Col>
          <Col>
          ...
          <em>
            <Col>
              <p className="responsiveText">
                Add Dolphin Grilled or Blackened for $5.00
              </p>
            </Col>
            <Col>
              <p className="responsiveText">
                Add Chicken Grilled or Blackened for $4.00
              </p>
            </Col>
          </em>
        </Row>
        ...
        <Row xs="1" className="mb-4">
          <Col>
            <div className="text-center">
              <h5 className="green-text">Dressings</h5>
              <p>
                Ranch, Blue Cheese, Honey Mustard, Balsalmic Vinaigrette,
                Caesar, or Oil and Vinegar.
              </p>
            </div>
          </Col>
        </Row>
        ...
        <Row className="my-5">
          <div style={{ width: "100%" }} className="text-center">
            <h5 className="mb-4">
              All Burgers and Sandwiches come with Chips and a Pickle
            </h5>
            <h5>
              Served on your choice of White, Wheat, Rye, Kaiser, Hoagie, or
              make it a wrap!
            </h5>
          </div>
        </Row>
